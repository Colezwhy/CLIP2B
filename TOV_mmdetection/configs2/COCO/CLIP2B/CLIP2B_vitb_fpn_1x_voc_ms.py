...
model = dict(
    ...
    neck=dict(
        type='FPN',
        in_channels=[768, 768, 768 + 20, 768], # the 4th channel is upscaled to 2068
        out_channels=256,
        start_level=0,
...
# optimizer
optimizer = dict(type='AdamW', lr=0.0002, weight_decay=0.0001,  # 0.0001
