...
model = dict(
    ...
    train_cfg=dict(
        base_proposal=dict(
            base_scales=[16, 32, 64, 128], ## 4  8 deleted
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1500, 360), (1500, 432), (1500, 512), (1500, 648), (1500, 750), (1500, 900)],
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(1500, test_scale) if test_scale else (1000, 600),
        flip=False,
        transforms=[
...
work_dir = '../../TOV_mmdetection_cache/work_dir/voc/P2B_voc/lr3e-3/' # to be changed

evaluation = dict(
    interval=1, metric='mAP',
    save_result_file=work_dir + '_' + 'pseudo_ann',
    do_first_eval=False,  # tests
    do_final_eval=True,
)
