...
# when named dense, the default backbone is with AttentionPool layer as output stage
    def __init__(self,
                 backbone,
                 text_encoder,
                 context_decoder,
    ...
    def compute_score_maps(self, x, text_features):
        ...
        # this method "einsum" can highly integrade some complex matrix operations
    ...
    def forward_train(self,
        ...
        # the loss function used in the base detector training process
        if self.use_seg_loss:
            losses['loss_seg'] = self.compute_seg_loss(img, score_map, img_metas, gt_bboxes, gt_labels)
        # storing all the loss for calling hook to implement back propogation
        return losses
